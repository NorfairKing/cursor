...
keyValueCursorTraverseKeyCase :: Applicative f => (kc -> v -> f (kc', v')) -> KeyValueCursor kc vc k v -> f (KeyValueCursor kc' vc k v')
keyValueCursorTraverseKeyCase func = \case
  KeyValueCursorKey kc v -> uncurry KeyValueCursorKey <$> func kc v
  KeyValueCursorValue k vc -> pure (KeyValueCursorValue k vc)

keyValueCursorTraverseValueCase :: Applicative f => (k -> vc -> f (k', vc')) -> KeyValueCursor kc vc k v -> f (KeyValueCursor kc vc' k' v)
keyValueCursorTraverseValueCase func = \case
