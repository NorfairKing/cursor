...
spec = do
  describe "makeMapCursor"
    ...
    $ producesValidsOnValids (makeMapCursor @Bool @Bool)
  describe "makeMapCursorWithSelection"
    $ it "produces valid cursors"
    $ producesValidsOnValids2 (makeMapCursorWithSelection @Bool @Bool)
  ...
  describe "mapCursorSelectKey"
    $ it "produces valid cursors"
    $ producesValidsOnValids (mapCursorSelectKey @Bool @Bool)
  describe "mapCursorSelectValue"
    $ it "produces valid cursors"
    $ producesValidsOnValids (mapCursorSelectValue @Bool @Bool)
  describe "mapCursorToggleSelected"
    $ it "produces valid cursors"
    $ producesValidsOnValids (mapCursorToggleSelected @Bool @Bool)
  ...
  describe "mapCursorInsertAndSelectKey"
    $ it "produces valid cursors"
    $ producesValidsOnValids3 (mapCursorInsertAndSelectKey @Bool @Bool)
  describe "mapCursorAppendAndSelectKey"
    $ it "produces valid cursors"
    $ producesValidsOnValids3 (mapCursorAppendAndSelectKey @Bool @Bool)
