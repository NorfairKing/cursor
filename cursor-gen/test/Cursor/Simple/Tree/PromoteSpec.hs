...
spec = do
  ...
  describe "treeCursorPromoteElem" $ do
    it "produces valids on valids" $ producesValidsOnValids $ treeCursorPromoteElem @Rational
      ...
      let promoteStart =
            TreeCursor
              { treeAbove =
                  Just
                    TreeAbove
                      { treeAboveLefts = S.singleton $ node 'b' [node 'c' []]
                      , treeAboveAbove =
                          Just
                            TreeAbove
                              ...
                              , treeAboveNode = 'p'
                              , treeAboveRights = S.singleton $ node 'h' []
                              }
                      , treeAboveNode = 'a'
                      , treeAboveRights = S.singleton $ node 'f' [node 'g' []]
                      }
              , treeCurrent = 'd'
              ...
              { treeAbove =
                  Just
                    TreeAbove
                      ...
                      , treeAboveAbove = Nothing
                      , treeAboveNode = 'p'
                      , treeAboveRights = S.singleton $ CNode 'h' emptyCForest
                      }
              , treeCurrent = 'd'
  ...
  describe "treeCursorPromoteSubTree" $ do
    it "produces valids on valids" $ producesValidsOnValids $ treeCursorPromoteSubTree @Rational
    it "Works on the example from the docs" $
      let promoteStart =
            TreeCursor
              { treeAbove =
                  Just
                    TreeAbove
                      { treeAboveLefts = S.singleton $ CNode 'b' $ closedForest [Node 'c' []]
                      , treeAboveAbove =
                          Just
                            TreeAbove
                              { treeAboveLefts = S.empty
                      ...
                      , treeAboveNode = 'a'
                      , treeAboveRights = S.singleton $ CNode 'f' $ closedForest [Node 'g' []]
                      }
              , treeCurrent = 'd'
              , treeBelow = closedForest [Node 'e' []]
              }
              ...
              { treeAbove =
                  Just
                    TreeAbove
                      ...
                      , treeAboveAbove = Nothing
                      , treeAboveNode = 'p'
                      , treeAboveRights = S.singleton $ CNode 'h' $ closedForest []
                      }
              , treeCurrent = 'd'
              , treeBelow = closedForest [Node 'e' []]
              }
