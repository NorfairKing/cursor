...
spec = do
  ...
  describe "makeNonEmptyCursor"
    ...
    $ producesValidsOnValids (makeNonEmptyCursor @Bool)
  ...
  describe "singletonNonEmptyCursor"
    $ it "produces valid cursors"
    $ producesValidsOnValids (singletonNonEmptyCursor @Bool @Bool)
  ...
  describe "nonEmptyCursorDeleteElem"
    $ it "produces valid cursors"
    $ producesValidsOnValids (nonEmptyCursorDeleteElem @Bool)
  describe "nonEmptyCursorSearch" $ do
    it "produces valid cursors when looking for an equal element"
      $ forAllValid
      $ \a -> producesValidsOnValids $ nonEmptyCursorSearch (== (a :: Bool))
  ...
  describe "nonEmptyCursorSelectOrAdd"
    $ it "produces valid cursors when looking for an equal element"
    $ forAllValid
    $ \a -> producesValidsOnValids $ nonEmptyCursorSelectOrAdd (== a) (a :: Bool)
